...
int read_config (void)
{
   ...
   // If this matches, autosave is not supported
    ...
    if ((adom_version != 111) && (adom_version != 12018) && (adom_version != 12050) && ((adom_version < 12020) || (adom_version > 12051)) && (config->enable_reroller != 0)) {
	log(log_config, "Config: ADOM version not 1.1.1 or 1.2.0p18/20-23/r48-49/r51+, disabling char reroller.\n");
