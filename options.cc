...
int read_config (void)
{
    ...
    log(log_config, "Config: ADOM version detected is %d\n", adom_version);
   ...
   // If this matches, autosave is not supported
    if ((adom_version != 111) && (adom_version != 12018) && (adom_version != 12050) && ((adom_version < 12020) || (adom_version > 12051)) && (config->enable_autosave != 0)) {
	log(log_config, "Config: ADOM version not 1.1.1 or 1.2.0p18/20-23/r48-49/r51, disabling autosaver.\n");
	config->enable_autosave = 0;
    }

    if ((adom_version != 111) && (adom_version != 12018) && (adom_version != 12050) && (adom_version != 12051) && ((adom_version < 12020) || (adom_version > 12059)) && (config->enable_reroller != 0)) {
	log(log_config, "Config: ADOM version not 1.1.1 or 1.2.0p18/20-23/r48-49/r51/r55/r59, disabling char reroller.\n");
