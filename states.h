...
public:
	const char * name(void) { return "passive"; };
};
...
public:
	const char * name(void) { return "startup"; };
	int waddch(WINDOW *win, chtype ch);
	int waddnstr(WINDOW *win, const char *str, int n);
};
...
public:
	StateRunning();
	const char * name(void) { return "running"; };
protected:
...
public:
	StateExamine();
	const char * name(void) { return "examine"; };
protected:
	virtual void handle_cmd(WINDOW *win, Command cmd);
};
...
public:
	StateLocate();
	const char * name(void) { return "locate"; };
protected:
	virtual void handle_cmd(WINDOW *win, Command cmd);
};
...
public:
	StateTarget();
	const char * name(void) { return "target"; };
protected:
	virtual void handle_cmd(WINDOW *win, Command cmd);
};
...
public:
	StateFullScreen();
	const char * name(void) { return "full screen"; };
	int wclear(WINDOW *win);
	int vsprintf(char *str, const char *format, va_list ap);
private:
	bool need_title;
...
public:
	const char * name(void) { return "info screen"; };
	int wgetch(WINDOW *win);
};
...
public:
	StateLevelUp();
	const char * name(void) { return "level up"; };
	int wclear(WINDOW *win);
	int vsprintf(char *str, const char *format, va_list ap);
private:
	bool done;
...
public:
	const char * name(void) { return "weapon stats"; };
	StateWeaponStats();
	int wmove(WINDOW *win, int y, int x);
...
public:
	const char * name(void) { return "extended drop"; };
	int wclear(WINDOW *win);
};

class StateRecall : public StateDrawable {
public:
	const char * name(void) { return "recall"; };
	int wgetch(WINDOW *win);
};
...
public:
	...
	const char * name(void) { return "swap"; };
	int wgetch(WINDOW *win);
...
public:
	StateAlchemy();
	const char * name(void) { return "alchemy"; };
	int wclear(WINDOW *win);
	int wmove(WINDOW *win, int y, int x);
	int waddch(WINDOW *win, chtype ch);
	int vsprintf(char *str, const char *format, va_list ap);
...
public:
	StateDynamicDisplay(StateCmdProcessor *cmd_processor, Command
			cmd_new_display);
	const char * name(void) { return "dynamic display"; };
	int wgetch(WINDOW *win);
	int vsprintf(char *str, const char *format, va_list ap);
private:
	size_t queue_size;
...
public:
	StateCastSpell();
	const char * name(void) { return "cast spell"; };
	int waddch(WINDOW *win, chtype ch);
	int waddnstr(WINDOW *win, const char *str, int n);
	int wgetch(WINDOW *win);
	int vsprintf(char *str, const char *format, va_list ap);
...
{
public:
	const char * name(void) { return "mindcraft"; };
	int wclear(WINDOW *win);
	int vsprintf(char *str, const char *format, va_list ap);
};
...
public:
	StateGameSummary();
	const char * name(void) { return "game summary"; };
	int wclear(WINDOW *win);
private:
	int clear_count;
};
...
public: 
	...
	const char * name(void) { return "memorial"; };
	int wgetch(WINDOW *win);
